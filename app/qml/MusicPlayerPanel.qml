...
Pane {
    ...
    ColumnLayout {
        ...
        Label {
            ...
            text: qsTr("MP3 playback now shares waveform-driven visuals with FluidSynth MIDI rendering and a repo-native ymfm VGM/VGZ/GYM synth path.")
    ...
    FileDialog {
        ...
        nameFilters: [
            qsTr("Audio files (*.mp3 *.wav *.ogg *.flac *.m4a *.mid *.midi *.vgm *.vgz *.gym)"),
            qsTr("All files (*)")
        ]

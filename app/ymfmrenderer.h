#ifndef YMFMRENDERER_H
#define YMFMRENDERER_H
...
class YmfmRenderer : public QObject
{
    Q_OBJECT
...
public:
    explicit YmfmRenderer(QObject *parent = nullptr);
    ~YmfmRenderer() override;
...
private:
    ...
    static YmfmRenderResult renderToWave(quint64 serial,
    ...
    QFutureWatcher<YmfmRenderResult> m_watcher;
